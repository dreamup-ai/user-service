...
const { PRIVATE_KEY_PATH, AWS_REGION, DYNAMODB_ENDPOINT, USER_TABLE } = process.env;
...
(0, node_assert_1.default)(PRIVATE_KEY_PATH, "PRIVATE_KEY_PATH is required");
const rawPrivateKey = node_fs_1.default.readFileSync(PRIVATE_KEY_PATH).toString("utf8");
